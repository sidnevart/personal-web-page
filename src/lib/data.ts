...
export const projects: Project[] = [
  {
    ...
    metrics: [
      ...
      { label: "Issues caught", value: "+120/wk" },
    ],
    links: [],
  ...
  },
  {
    ...
    metrics: [
      { label: "Pipeline speedup", value: "20 min" },
      { label: "Flaky tests eliminated", value: "100%" },
    ],
    links: [],
  ...
  },
  {
    ...
    metrics: [
      ...
      { label: "Senior dev interruptions", value: "-60%" },
    ],
    links: [],
  ...
  },
  {
    ...
    metrics: [
      { label: "Campaign setup time", value: "-70%" },
      { label: "Manual tasks automated", value: "15+/wk" },
    ],
    links: [],
  ...
  },
  {
    ...
    results: [
      ...
      "Unified data source for realtors",
      "Analytics works for any Russian region, street, or district — scalable nationwide",
      "Reduced manual data collection by 90%",
    ],
  ...
  },
  {
    ...
    results: [
      ...
      "AI partner support reduced slot vacancy by 35%",
      "Smart pricing recommendations increased partner revenue by 20%",
      "Internal recommendation engine boosted booking conversion by 25%",
    ],
  ...
  },
  {
    ...
    slug: "proof-forge",
    title: "ProofForge",
    subtitle: "Corporate platform for employee development through peer accountability",
    ...
    results: [
      ...
      "Peer accountability mechanics with proof workflows",
      "AI-generated growth dossiers for 1:1 and review readiness",
      "Team workspaces for structured employee development",
      "Peer accountability increased goal completion by 45%",
      "AI-generated growth dossiers saved 5+ hours per 1:1 prep",
    ],
  ...
  },
  {
    ...
    results: [
      "Team engagement increased by 40% vs video-call-only workflow",
      "Weekly AI reports saved 8+ hours of manual analysis per team lead",
      "Faster informal decisions via lounge and hot-desk zones",
      "AI office setup achieved 60% token cost reduction with Grafana monitoring",
    ],
...
export const experiences: Experience[] = [
  {
    ...
    description:
      "Building backend systems for a cashback targeting platform. Introduced AI-assisted workflows into engineering and operational processes.",
    highlights: [
      "Targeting logic by financial data over 30M transactions/day, 1.5 years of history",
      "5x speedup via ClickHouse migration",
      "40-60 hours/month manual work saved",
      "AI code review, CI refactor bot, RAG onboarding agent",
      "Personalized AI assistant for customer recommendations based on transactions",
      "AI office setup with OpenClaw, Grafana monitoring, 60% token cost reduction",
      "Bank-wide code agent skills library, growing exponentially across teams",
      "Removed 80% of legacy code, achieved full documentation coverage",
      "Accelerated CI/CD by 10%, eliminated all flaky tests",
      "Resolved major document workflow incident",
      "CI/CD pipeline accelerated by 30% (20 min faster per run)",
...
export const siteConfig = {
  ...
  description:
    "Backend engineer focused on data-intensive systems, internal platforms, AI automation, and developer productivity. Nearly 4 years of experience across banking, analytics, Telegram Mini Apps, and open-source.",
  url: "https://sidnev.dev",
  email: "a.sidnevart@gmail.com",
  social: {
    github: "https://github.com/sidnevart",
    linkedin: "https://www.linkedin.com/in/artem-sidnev",
